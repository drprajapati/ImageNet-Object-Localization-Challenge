...
class Config:
    def __init__(self):
        ...
        self.model_path = '../models/second_darshan_frcnn_model.hdf5'

        # params add by me
        self.data_dir = '../ILSVRC/Data/'
        self.num_epochs = 50

        self.kitti_simple_label_file = '../ilsvrc_annot.txt'
        ...
        self.simple_label_file = '../ilsvrc_annot.txt'

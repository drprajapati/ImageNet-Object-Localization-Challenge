...
def train_kitti():
    ...
    cfg.rot_90 = False
    cfg.num_rois = 64
    cfg.base_net_weights = os.path.join('models/', nn.get_weight_path())

    # TODO: the only file should to be change for other data to train
    cfg.model_path = 'models/darshan_frcnn_model.hdf5'
    cfg.simple_label_file = 'ilsvrc_annot.txt'
    ...
    img_input = Input(input_shape_img,3)

...
def nn_base(input_tensor=None, trainable=False):
    ...
    # Block 6
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block4_conv1')(x)
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block4_conv2')(x)
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block4_conv3')(x)
